...
<body>
	<div class="board-detail__wrapper">
		...
		<c:if test="${sessionScope.loginMember.a_id eq board.f_id }">
	...
	<div class="board-reply__wrapper">
		...
		<c:forEach var="reply" items="${reply }">
			<form action="free.reply.delete" method="post"
			...
			<form action="free.reply.write">
				...
				<div class="board-reply__write-wrapper">
					...
					<div class="board-reply__write">
						<textarea name="fr_text" maxlength="1000"></textarea>
					</div>
