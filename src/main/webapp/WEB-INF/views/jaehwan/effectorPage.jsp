  ...
  <script>
    ...
    <c:forEach var="p" items="${products}">
      var item = {
        name: '${p.p_name}',
        color: '${p.p_color}',
        smallCategory: '${p.p_small_category}',
        maker: '${p.p_maker}',
        price: '${p.p_price}',
        sale : '${p.p_sale}',
        imgUrl: '${p.p_img1}',
    ...
    container.pagination({
        ...
        callback: function (data, pagination) {
            ...
            $.each(data, function (index, item) {
                ...
                dataHtml += '<div class="ul-div product-img"><img src="resources/img/Amp/' + item.imgUrl + '" class="productImg"></div>';
                if (item.maker !== '') {
                    dataHtml += '<div class="ul-div product-logo"><img src="resources/img/MakerLogo/' + item.maker + '_Logo_White.png" class="LogoImg"></div>';
                }
                dataHtml += '<div class="ul-div productColor" style="display:none;">[' + item.color + ']</div>';
                dataHtml += '<div class="ul-div productSmallCategory">' + item.smallCategory + '</div>';
              ...
              if (item.price !== item.sale) {
                  ...
                  dataHtml += ' style="color: red; font-size: 20px;">';
                  dataHtml += new Intl.NumberFormat('ko-KR', {
                      style: 'currency',
                      currency: 'KRW'
                  }).format(item.sale);
              ...
              // 할인율
              var priceDifference = item.price - item.sale;
              var pricePercentage = (priceDifference / item.price) * 100;
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(response, function (index, item) {
                   ...
                   dataHtml += '<div class="ul-div productColor" style="display:none;">' + item.p_color + '</div>';
				   ...
				   dataHtml += '<div class="aaa">' // aaa div 시작
                   	  dataHtml += '<div class="productPrice"';
