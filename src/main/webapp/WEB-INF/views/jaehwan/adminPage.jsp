...
<body>
  <div class="listPage_contents" id="listPage_contents">
    <div class="detail_Search_Window">
      <form id="searchDetail" action="searchDetail" method="post" style="justify-content:end;">
        <select class="productControl" id="controlSelect"  style="margin:20px;">
          <option value="상품관리">상품관리</option>
          <option value="주문관리">주문관리</option>
          <option value="매상/매출">매상/매출</option>
        </select>
        ...
        <select class="sortOrder" id="sortSelect" style="margin:20px;">
  ...
  <div class="popup" id="regProductPopup">
        ...
        <br>
					...
					<div class="btn-area">
						<button class="loginConfirm_btn" id="btn">등록</button>
					</div>
				</form>
				</div>
			</div>
<div class="dim-for-reg" id="dim-for-reg"></div>
    	    ...
    	    container.pagination({
    	        ...
    	        callback: function (data, pagination) {
    	            ...
    	            $.each(data, function (index, item) {
    	              ...
    	              dataHtml += '<div>'; 			              
    	              dataHtml += '<div class="productModify" style="display:flex;">';
    	              dataHtml += '<button><a href="#updateProductPopup" class="update-popup--btn">수정</a></button>'
    	              dataHtml += '<button><a href="deleteProduct?p_no='+ item.p_no + '">삭제</a></button>'
    	              dataHtml += '</div>';
    	              ...
    	              dataHtml += '</div>';
    	                ...
    	                dataHtml += '<button><a href="#regProductPopup" class="reg-popup--btn">등록</a></button>'
...
function updateResults() {
	const controlSelect = $("#controlSelect").val();
    ...
    const requestData = {
    	"p_middle_category": middleCategory,
        "p_maker": companyName,
