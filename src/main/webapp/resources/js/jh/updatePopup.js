$(function () {
 ...
 $(".update-popup--btn").click(function () {
        ...
        let productItem = productModify.closest(".listPage_item1");
 		...
 		let p_big_category = productItem.find(".p_big_category").val();
        ...
        let p_maker = productItem.find(".companyBy").val();
		...
		console.log(p_middle_category);    // ㄴ
		console.log(p_small_category);     // ㄴ
		console.log(p_maker);
		console.log(p_color);
		console.log(p_name);
		console.log(p_price);
