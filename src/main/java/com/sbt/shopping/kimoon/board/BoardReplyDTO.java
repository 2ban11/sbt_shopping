...
public class BoardReplyDTO {
	...
	public int getFr_text() {
		return fr_text;
	}
	public void setFr_text(int fr_text) {
	...
	public int getFr_date() {
		return fr_date;
	}
	public void setFr_date(int fr_date) {
	...
	public int getLr_text() {
		return lr_text;
	}
	public void setLr_text(int lr_text) {
	...
	public int getLr_date() {
		return lr_date;
	}
	public void setLr_date(int lr_date) {
	...
	public int getJr_text() {
		return jr_text;
	}
	public void setJr_text(int jr_text) {
	...
	public int getJr_date() {
		return jr_date;
	}
	public void setJr_date(int jr_date) {
